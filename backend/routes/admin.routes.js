...
//Document Routes 
router.post('/documents/add',multerUploadInMemory.single("file"),async (req, res) => {
...
router.post('/presentations/add',multerUploadInMemory.single("file"),async (req, res) => {
...
//notice Routes
router.post('/notices/add',multerUploadInMemory.single("file"),async (req, res) => {
