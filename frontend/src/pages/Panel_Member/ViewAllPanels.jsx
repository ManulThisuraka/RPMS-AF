...
filterData(panels,searchKey){
  const result = panels.filter((post) =>
      ...
      <div className="viewPanel-container">
          <div className="row">
            <div className="col-lg-9 mt-2 mb-2"><br></br><br></br><br></br>
              <h1><center><b>All Panel Details</b></center></h1> <br></br> 
            </div>
              ...
              <tbody>
                  {this.state.panels.map((panels,index) => (
                    <tr>
                      ...
                      <td>
                        <a className="btn btn-secondary btn-sm btn-block" href={`/edit/${panels._id}`}>
                          <i className="fas fa-edit"></i>&nbsp;UPDATE   
                        </a> 
                        &nbsp; 
                        <a className="btn btn-secondary btn-sm btn-block" href="#" onClick={() =>this.onDelete(panels._id)}>
