...
filterData(finalmarks,searchKey){
  const result = finalmarks.filter((post) =>
      ...
      <div className="viewFinalmarks-container">
          <div className="row">
            <div className="col-lg-9 mt-2 mb-2"><br></br><br></br><br></br>
              <h1><center><b>All Final Marks Details</b></center></h1> <br></br> 
            </div>
              ...
              <tbody>
                  {this.state.finalmarks.map((finalmarks,index) => (
                    <tr>
                      ...
                      <td>
                        <a className="btn btn-secondary btn-sm btn-block" href={`/edit/${finalmarks._id}`}>
                          <i className="fas fa-edit"></i>&nbsp;UPDATE   
                        </a> 
                        &nbsp; 
                        <a className="btn btn-secondary btn-sm btn-block" href="#" onClick={() =>this.onDelete(finalmarks._id)}>
